    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Dompetku App</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('admin/balance') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('admin/type') ?>">
            ...
            <li class="nav-item">
                ...
                <div id="transaction" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('admin/income') ?>">Income</a>
                        <a class="collapse-item" href="<?= base_url('admin/expense') ?>">Expense</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#selfReport"
                    aria-expanded="true" aria-controls="selfReport">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Self Report</span>
                </a>
                <div id="selfReport" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Transaction</h6>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#parentReport"
                    aria-expanded="true" aria-controls="parentReport">
                    <i class="fas fa-fw fa-user-shield"></i>
                    <span>Parent Report</span>
                </a>
                <div id="parentReport" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Transaction</h6>
                        <a class="collapse-item" href="#">Income</a>
                        <a class="collapse-item" href="#">Expense</a>
